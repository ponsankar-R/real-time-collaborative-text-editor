    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Collab Editor</h1>
          <p className="text-gray-600 mt-2">Real-time collaborative editing</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl 
                     bg-white px-6 py-4 border-2 border-gray-200 
